...
class MMNISTExperiment(BaseExperiment):
    ...
    def set_dataset(self):
        ...
        train = MMNISTDataset(self.flags.unimodal_datapaths_train, self.flags.unimodal_labelpaths_train)
        test = MMNISTDataset(self.flags.unimodal_datapaths_test, self.flags.unimodal_labelpaths_test)
