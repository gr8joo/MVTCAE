...
# clfs
parser.add_argument('--dir_clf', type=str, default='.', help="directory where clf is stored")
# data
parser.add_argument('--dir_data', type=str, default='.', help="directory where data is stored")

# experiments
parser.add_argument('--dir_experiment', type=str, default='.', help="directory to save generated samples in")
# fid
parser.add_argument('--dir_fid', type=str, default='.', help="directory to save generated samples for fid score calculation")
...
# data
parser.add_argument('--datapaths', default='.', type=str, help="directories where training data is stored")
